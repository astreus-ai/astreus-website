...
OPENAI_EMBEDDING_API_KEY=sk-embedding-key  # Optional separate key for embeddings
...
GOOGLE_BASE_URL=https://generativelanguage.googleapis.com  # Optional custom base URL
