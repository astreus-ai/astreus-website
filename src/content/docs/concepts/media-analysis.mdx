...
description: AI-powered image, document, and file analysis capabilities
---

Astreus includes powerful AI-powered media analysis capabilities that allow your agents to understand and analyze various types of media files including images, documents, and other file formats.
...
Implement proper error handling for media analysis:
