...
Astreus supports two RAG types:
...
```typescript
// Create specialized RAG systems
...
const results = await rag.search({ query: "test query" });
```

## Next Steps

Once you have RAG working:
