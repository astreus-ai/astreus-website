...
Memory in Astreus is **agent-centric** and provides powerful conversation history management with **session-based organization**. Instead of managing memory separately, you access it directly through agents with built-in session tracking.
